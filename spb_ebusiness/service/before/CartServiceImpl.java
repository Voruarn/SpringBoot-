...
import com.ch.spb_ebusiness.util.before.CartRepository;
import com.ch.spb_ebusiness.repository.before.IndexRepository;
import com.ch.spb_ebusiness.util.MD5Util;
...
public class CartServiceImpl implements CartService{
    ...
    public String pay(Order order) {
        ...
        System.out.println("(pay)order.getId():"+order.getId());
        System.out.println("(pay)order.getBusertable_id():"+order.getBusertable_id());
        return "forward:/";
    }

    public String pay2(Integer oid){
        cartRepository.pay(oid);
        System.out.println("(pay2)oid:"+oid);
        return "forward:/";
    }
